...
/**
 * A functional component representing a contact form.
 *
    ...
    >
      ...
      <div className="flex flex-col gap-8 md:flex-row md:gap-4">
        <div className="relative flex-1">
          ...
          <input
            ...
            className={cn(
              "w-full rounded-3xl border border-card bg-card p-4 text-primary shadow-sm outline-none",
      ...
      <div className="relative flex h-full flex-col">
        ...
        <textarea
          placeholder="Message"
          className={cn(
            "min-h-40 w-full flex-grow resize-none rounded-3xl border border-card bg-card p-4 text-primary shadow-sm outline-none",
