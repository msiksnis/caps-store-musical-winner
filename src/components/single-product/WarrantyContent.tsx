  ...
  return (
    <div className="space-y-4 text-pretty pb-4 font-light md:pb-10">
      <p>
        ...
        from &apos;Support&apos; section to submit a warranty claim.
      </p>
      <p>
        After you&apos;ve completed and submitted the warranty claim form our
        customer service team will proceed with your claim within two business
      ...
      <p>
        ...
        confirmation email, followed by a shipping confirmation email with a
        tracking number for your replacement product once they have been
        shipped. Please do not discard your faulty product until you receive
        your replacement.
      </p>
    </div>
  );
