  ...
  return (
    ...
    >
      ...
      <Search
        ...
        className={cn(
          "focus:text-primary mt-4 h-10 w-full cursor-pointer rounded-full border pl-8 outline-none transition-all duration-200 focus:cursor-text focus:placeholder:opacity-100 sm:mt-0 sm:size-10 sm:border-transparent sm:p-2 sm:pl-0 sm:placeholder:opacity-0 focus:sm:w-40 focus:sm:pl-4 focus:md:w-72",
          {
